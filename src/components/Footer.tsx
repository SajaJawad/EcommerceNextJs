    ...
    <div className='py-24 px-4 md:px-8 lg:px-16 xl:32 2xl:px-64 bg-gray-100 text-sm mt-24'>
      ...
      <div className="flex flex-col md:flex-row justify-between gap-24 ">
        ...
        <div className="w-full md:w-1/2   lg:w-1/4 flex flex-col gap-8 ">
          ...
          <p className=''>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Labore, ipsum?</p>
        ...
        <div className="w-full md:w-1/2   lg:w-1/4 flex flex-col gap-8 ">
          ...
          <p className="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque tempora reprehenderit iste nulla numquam! Sit.</p>
          <div className='flex'>
      ...
      {/* BOTTOM */}
      <div mt- className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
        <div className="">
          2024 Lama Shop
        </div>
